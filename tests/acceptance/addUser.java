...
public class addUser {
	...
	public void validTest1() {
		...
		if (oo.getState() == InputHandler.CLERK) {
			String input = "jacobperks,password123";
			o = outputHandler.createUser(input);
    		oo.setOutput(o.getOutput());
            oo.setState(o.getState());
            if (oo.getState() == InputHandler.CREATEUSER) {
            	input = "jacob@carleton.ca,password123";
    			o = outputHandler.createUser(input);
        		oo.setOutput(o.getOutput());
                oo.setState(o.getState());
                result = o.getOutput();
	...
	public void invalidTest2() {
		...
		if (oo.getState() == InputHandler.CLERK) {
			String input = "zhibo@carleton.ca,password123";
			o = outputHandler.createUser(input);
    		oo.setOutput(o.getOutput());
            oo.setState(o.getState());
            result = o.getOutput();
		...
		assertEquals("The User Already Exists!", result);
	}
